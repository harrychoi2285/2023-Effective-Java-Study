package org.adtado.harrypota.effective.item01;
...
public class UserInfo {
    ...
    public static UserInfo inforation(String name, int age) {
    ...
    public static void main(String[] args) {
        // 정적 팩터리 메서드 사용
        UserInfo userInfo = inforation("harry", 27);

        // 생성자 사용
        UserInfo user1 = new UserInfo("Pota", 28);
